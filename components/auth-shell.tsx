...
const points = [
    'Regime-first analysis for traders and research teams',
    'Trend, volatility, and strategy-fit in one workspace',
    'Decision support built for daily market review',
];
                ...
                <section className="max-w-xl space-y-6">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-4xl font-semibold tracking-tight text-foreground sm:text-5xl">
                            {isSignIn ? 'Return to the market desk' : 'Create your RegimeLens account'}
                        </h1>
                        <p className="max-w-lg text-base leading-7 text-muted-foreground sm:text-lg">
                            {isSignIn
                                ? 'Sign in to continue reviewing market regime, trend quality, and instability signals.'
                                : 'Set up access to a disciplined market intelligence workspace for trend and regime analysis.'}
                        </p>
                    </div>
